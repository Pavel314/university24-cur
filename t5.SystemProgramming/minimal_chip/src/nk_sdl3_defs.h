/*Define NK_IMPLEMENTATION and NK_SDL3_RENDERER_IMPLEMENTATION  this in translation unit*/
#ifndef NK_SDL3_DEFS_H
#define NK_SDL3_DEFS_H
/*See https://github.com/Immediate-Mode-UI/Nuklear/blob/master/demo/sdl3_renderer/main.c*/
#include <SDL3/SDL.h>
